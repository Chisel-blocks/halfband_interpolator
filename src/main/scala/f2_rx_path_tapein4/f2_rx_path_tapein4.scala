...
class f2_rx_path_tapein4 (n: Int=16, users: Int=4) extends Module {
...
object f2_rx_path_tapein4 extends App {
  chisel3.Driver.execute(args, () => new f2_rx_path_tapein4)
}
